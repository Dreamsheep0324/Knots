...
class AddChatViewModelTest {
    ...
    fun setUp() {
        ...
        viewModel = AddChatViewModel(eventRepository, contactRepository, DialogueLineManager(), eventManageUseCase, savedStateHandle)
    }
    ...
    fun saveChatCallsInsert() = runTest {
        ...
        viewModel.saveChat()
        coVerify { eventManageUseCase.insertEventWithParticipants(any(), listOf(1L)) }
    }
