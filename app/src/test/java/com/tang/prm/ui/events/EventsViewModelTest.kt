...
class EventsViewModelTest {
    ...
    fun init_sortsEventsByTimeDescending() = runTest {
        viewModel.uiState.test {
            ...
            assertThat(state.events[1].title).isEqualTo("Dinner")
        }
    }
    ...
    fun selectType_updatesState() = runTest {
        ...
        assertThat(viewModel.uiState.value.selectedType).isEqualTo("MEETUP")
    }
    ...
    fun selectType_null_showsAllEvents() = runTest {
        ...
        assertThat(viewModel.uiState.value.selectedType).isNull()
    }
    ...
    fun onSearchQueryChange_updatesState() = runTest {
        ...
        assertThat(viewModel.uiState.value.searchQuery).isEqualTo("Meet")
    }
    ...
    fun onViewModeChange_updatesState() = runTest {
        ...
        assertThat(viewModel.uiState.value.viewMode).isEqualTo("grid")
    }
