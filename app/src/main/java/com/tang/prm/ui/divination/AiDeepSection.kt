...
fun AiDeepSection(
    ...
    val savedGender by viewModel.savedGender.collectAsState()
    val savedBirthDate by viewModel.savedBirthDate.collectAsState()
                        ...
                        OutlinedButton(
                            onClick = {
                                if (question.isNotBlank()) {
                                    viewModel.startLiuyaoAnalysis(liuyaoData, gender, birthDate, question)
                                }
                            },
                            modifier = Modifier.fillMaxWidth(),
                            shape = RoundedCornerShape(8.dp),
