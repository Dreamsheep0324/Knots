...
- 详情页整合资料、事件、纪念日、礼物、想法、对话、人物关系七大板块。
- 人物关系：记录该联系人与其他人的社交关系，关系对象可以是 App 内联系人也可以是外部人物（仅填姓名），支持关系类型、自定义关系词与备注。

### 关系图谱

- 以"我"为中心可视化呈现你与所有联系人的关系网络，让人物关系一目了然。
- 力导向视图：节点按力学模拟自然分布，支持自由拖拽节点、双指缩放与平移画布。人物间关系以流光虚线连接，线上标注关系类型；选中节点或连线时底部弹出详情卡片。
- 星系视图：联系人围绕"我"按亲密度分层旋转，内圈家人、外圈新识，轨道半径与转速随亲密度递减，形成层次分明的星系结构。
- 事件节点：力导向视图中可选择显示共同事件节点，事件与相关人物自动连线，事件类型图标智能匹配（如含"餐"显示餐厅图标、含"见/聚/面"显示人群图标）。
- 关系编辑：长按人物节点进入编辑模式可绘制关系连线，选择关系类型后保存；长按连线可删除关系。
- 自定义关系类型：内置家人、朋友、同事、同学、邻居、其他 6 个预设关系类型，可在自定义类型管理中增删改。
- 视觉层次：高亲密度人物添加呼吸光晕，"我"节点金色脉冲扩散光环，选中节点旋转双色光环，关系边流动光粒子与脉搏波动画。
...
- 记录送出和收到的礼物，区分方向，支持分类、场合、地点等详细信息。
...
- 今日事件、即将到来事件、下一事件倒计时。
- 力导向图预览：在显示设置中开启"首页力导向图"后，首页轨道罗盘替换为力导向关系图谱，点击人物节点直接跳转详情，人物关系网络在首页即可一览。
...
- 2800×1840 分辨率专属适配，首页、事件、纪念、对话、人物、相册六大界面平板专属布局。
- 统一浅色模式，侧边导航栏，宽屏空间优化。
- 平板模式可在设置中开关，基于屏幕宽度 600dp 断点自动判断。
...
- 架构模式：MVVM + Clean Architecture（17 模块）
- 依赖注入：Hilt
- 本地数据库：Room 2.7.0
